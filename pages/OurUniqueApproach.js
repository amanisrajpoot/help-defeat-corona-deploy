        ...
        <div className="">
          ...
          <div className="flex flex-col justify-center items-center text-sm rounded-lg ml-4 w-full px-4">
            ...
            <div className="space-x-2 mb-4">
              <h1 className="font-bold text-5xl py-4">USING AI TO HELP DEFEAT COVID-19</h1>
            ...
            <div className="space-x-2 mb-4">
              <h1 className="font-bold text-5xl py-4">WHAT ARE THE SYMPOMS OF COVID-19?</h1> 
      ...
      <div className="flex flex-col w-3/5 h-full space-y-2  m-6 p-4 border-2 
        ...
        <div className="">
          ...
          <div className="flex flex-col justify-center items-center text-sm rounded-lg ml-4 w-full px-4">
            ...
            <div className="space-x-2 mb-4">
              <h1 className="font-bold text-5xl py-4 m-2">STEPS</h1>
